 ...
 * StudioMan                                                                  *
 *                                                                            *
 * This class is an abstract superclass which corresponds to the Property     *
 * managed object. It contains properties that are common to the email,       *
 * phone, and address entities.                                               *
 *                                                                            *
 ******************************************************************************/
...
@interface SMPropertyMO : NSManagedObject {
@private
}
